...
- **/docs/** — Startup strategy, market research, and product planning
- **/design/** — UX wireframes, Figma exports, and visual identity drafts
- **/prototype/** — MVP scaffold (React, WebRTC, Firebase)
- **/notes/** — Meeting notes, ideas, and research findings

## 🚀 Current Phase

_Phase 1 – Foundation & Validation_  
We’re currently refining the market positioning, SWOT analysis, and prototype scope before building the interactive MVP.

## 🧠 Keywords

`edtech` `family tech` `remote learning` `startup` `webrtc` `reading` `react` `prototype`

---

> “Read together, even when you’re apart.” ❤️
